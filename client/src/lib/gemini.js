...
// const safetySettings = [ // Renamed to plural for clarity
//   {
//     category: HarmCategory.HARM_CATEGORY_HARASSMENT,
//     threshold: HarmBlockThreshold.BLOCK_LOW_AND_ABOVE,
//   },
...
// const model = genAI.getGenerativeModel({
//   model: "gemini-2.5-flash", // You can also try "gemini-1.5-flash-latest"
//   safetySettings,            // FIXED: Changed from safetySetting to safetySettings
//   generationConfig: {
//     temperature: 0.7,
//     topP: 0.8,
//     topK: 40,
